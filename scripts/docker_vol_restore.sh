...
cd /home/ec2-user/sonarqube-docker-h2
docker-compose down --remove-orphans

# Restore all other volumes
echo "Restoring Docker volumes..."
for VOLUME in sonarqube-docker-h2_postgresql_data sonarqube-docker-h2_sonarqube_conf sonarqube-docker-h2_sonarqube_data sonarqube-docker-h2_sonarqube_extensions sonarqube-docker-h2_sonarqube_logs; do
